...
function main() {
  ...
  if (eventName === "SessionStart") emitOutput({ hook: "opencode.SessionStart", workspaceRoot: resolveWorkspaceRoot(cwd), timestamp: nowIso() });
  else if (eventName === "SessionEnd") emitOutput({ hook: "opencode.SessionEnd", workspaceRoot: resolveWorkspaceRoot(cwd), timestamp: nowIso() });
}
main();